...
{
    public sealed class MasterStateMachine
    {
        private readonly List<StateMachine> stateMachines = new List<StateMachine>();
        ...
        internal bool ChangeStateMachine(Type stateMachineType, Type stateType, IStateData args = null)
        {
